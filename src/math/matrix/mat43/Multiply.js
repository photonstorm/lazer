...
export function Multiply (a, b, dst = new mat(12)) {
...
export function mat33 (a, b, dst = new mat(12)) {
    ...
    dst[7] =  b1 * a6 + b4 * a7 + b7 * a8;
    dst[8] =  b2 * a6 + b5 * a7 + b8 * a8;
    dst[9]  = b0 * a9 + b3 * a10 + b6 * a11;
    dst[10] = b1 * a9 + b4 * a10 + b7 * a11;
    dst[11] = b2 * a9 + b5 * a10 + b8 * a11;

    return dst;

}

export function mat44 (a, b, dst = new mat(12)) {
